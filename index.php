...
<html lang="en">
  ...
  <br><br>
    ...
    <footer class="footer bg-dark">
      <div class="container">
        <p class="m-0 text-center text-white" ><b> Equipo: </b></p>
		<p class="m-0 text-center text-white" ><b> Francisco Javier Solis Bamaca - B200108</b></p>
		<p class="m-0 text-center text-white" ><b> Paola Jadziry Culebro Ovando - B200065 </b></p>
      </div>
    </footer>
